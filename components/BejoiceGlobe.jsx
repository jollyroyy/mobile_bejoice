...
export default function BejoiceGlobe({ embedded = false, fullscreen = false }) {
  ...
  useEffect(() => {
    ...
    const PORT_NODES = [
      { lat: 21.5,  lng: 39.2,   r: 1.02, port: true  },
      { lat: 25.2,  lng: 55.3,   r: 1.02, port: true  },
      { lat: 30.0,  lng: 31.2,   r: 1.02, port: true  },
      { lat: 37.9,  lng: 23.7,   r: 1.03, port: true  },
      { lat: 51.9,  lng:  4.5,   r: 1.04, port: true  },
      { lat: 53.5,  lng:  9.9,   r: 1.04, port: true  },
      { lat: 11.6,  lng: 43.1,   r: 1.02, port: true  },
      { lat: 19.1,  lng: 72.9,   r: 1.03, port: true  },
      { lat:  1.3,  lng: 103.8,  r: 1.03, port: true  },
      { lat: 22.3,  lng: 114.2,  r: 1.03, port: true  },
      { lat: 31.2,  lng: 121.5,  r: 1.03, port: true  },
      { lat: 35.7,  lng: 139.7,  r: 1.04, port: true  },
      { lat: 37.5,  lng: 126.9,  r: 1.04, port: true  },
      { lat: -33.9, lng: 151.2,  r: 1.04, port: true  },
      { lat: 40.7,  lng: -74.0,  r: 1.04, port: true  },
      { lat: 34.0,  lng: -118.2, r: 1.04, port: true  },
      { lat: 29.7,  lng: -95.4,  r: 1.03, port: true  },
      { lat: -23.5, lng: -46.6,  r: 1.03, port: true  },
      { lat: -33.9, lng: 18.4,   r: 1.03, port: true  },
      { lat:  6.5,  lng:  3.4,   r: 1.02, port: true  },
      { lat: -4.0,  lng: 39.7,   r: 1.02, port: true  },
      { lat: 55.7,  lng: 37.6,   r: 1.04, port: true  },
      { lat: 43.1,  lng: 131.9,  r: 1.04, port: true  },
    ];
        ...
        >
          ...
          <h2 className="no-reveal" style={{
            ...
            {isAr ? ar.globe.headline : <>
              <span style={{ color: '#ffffff', textShadow: '0 1px 12px rgba(0,0,0,0.9)' }}>BEJOICE CONNECTS </span><br/>
              <span style={{ color: 'var(--gold)', textShadow: '0 1px 12px rgba(0,0,0,0.9), 0 0 20px rgba(91,194,231,0.3)' }}>SAUDI TO THE WORLD</span>
            </>}
          </h2>

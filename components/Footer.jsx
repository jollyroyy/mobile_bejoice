      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '8px' }}>
          <h2 style={{
            ...
            letterSpacing: isAr ? 0 : '0.08em', color: '#ffffff', margin: 0,
          ...
          <button
            ...
            style={{
              ...
              fontSize: '18px', flexShrink: 0, marginLeft: isAr ? 0 : '16px', marginRight: isAr ? '16px' : 0,
              display: 'flex', alignItems: 'center', justifyContent: 'center',
            }}
          >✕</button>
        </div>
        ...
        {/* Sections */}
        {(isAr && policy.arSections ? policy.arSections : policy.sections).map(s => (
          <div key={s.title} style={{ marginBottom: '28px' }}>
            <h3 style={{
              fontFamily: isAr ? "'Cairo','Noto Sans Arabic',sans-serif" : "'DM Sans', sans-serif", fontWeight: 700,
